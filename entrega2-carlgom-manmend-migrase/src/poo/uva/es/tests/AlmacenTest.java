...
public class AlmacenTest {
	...
	public void almacenConVendibles() {
		...
		Promo peraEnOferta = new Promo(NOMBRE_PRODUCTO, DESCRIPCION_PRODUCTO, 1, PROMO_INICIO, PROMO_FIN);
		Combo multiplesPeras = new Combo(NOMBRE_PRODUCTO, DESCRIPCION_PRODUCTO);
